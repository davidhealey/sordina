...
String hise::FrontendHandler::getProjectName() { return "Sordina"; };
String hise::FrontendHandler::getCompanyName() { return "Libre Wave"; };
String hise::FrontendHandler::getCompanyWebsiteName() { return "https://libreWave.com"; };
